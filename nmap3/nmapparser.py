    ...
    def filter_top_ports(self, xmlroot):
        ...
        try:
            ...
            for hosts in scanned_host:
                ...
                if hosts.find("status") is not None:
                    for key in hosts.findall("address"):
                        addresses.append(key.attrib)

                port_result_dict[address] = {}
                port_result_dict[address]["address"]=addresses
                ...
                port_result_dict[address]["ports_result"]=port_results
